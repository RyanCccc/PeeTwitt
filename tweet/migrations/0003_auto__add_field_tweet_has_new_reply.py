...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Tweet.has_new_reply'
        db.add_column(u'tweet_tweet', 'has_new_reply',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Tweet.has_new_reply'
        db.delete_column(u'tweet_tweet', 'has_new_reply')
    ...
    models = {
        ...
        u'tweet.tweet': {
            ...
            'author': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['pee_user.PeeUser']"}),
            'content': ('django.db.models.fields.CharField', [], {'max_length': '140'}),
            'has_new_reply': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'timestamp': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'})
        }
    }
